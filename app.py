...
if siglas_input:
    ...
    for idx, sigla in enumerate(lista_siglas):
        with cols[idx]:
            # Solução definitiva: Usando o índice numérico (idx) na key para estabilizar o Streamlit
                ...
                with ZipFile(zip_buffer, "w") as zip_file:
                    for sigla in lista_siglas:
                        ...
                        if p_original is not None and p_original > 0:
                            ...
                            try:
                                # Mantém a busca inteligente do arquivo físico com "_"
                                ...
                                erros_cidades.append(f"{sigla} (Template não encontrado como: templates/{sigla_segura}-SHIPPER-t.docx)")
                        else:
